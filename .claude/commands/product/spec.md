...
- Consulte as META SPECS do projeto no caminho configurado em `meta_specs_path` no arquivo `ai.properties.md` na raiz do projeto
...
1. **Validação** (`/check`) - Verificação contra Meta Specs
