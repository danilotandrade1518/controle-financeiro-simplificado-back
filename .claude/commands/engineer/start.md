...
- Revise diretrizes técnicas em: Meta Specs estão no caminho configurado em `meta_specs_path` no arquivo `ai.properties.md` na raiz do projeto.
...
- [Meta Specs]: Meta Specs estão no caminho configurado em `meta_specs_path` no arquivo `ai.properties.md` na raiz do projeto.
